...
// in mobile/test/measure_provider_test.dart.
...
import 'package:mobile/utils/secure_storage.dart' as _i7;
...
class MockSecureStorage extends _i1.Mock implements _i7.SecureStorage {
  ...
  @override
  _i3.Future<void> writeUserId(int? id) =>
      (super.noSuchMethod(
            Invocation.method(#writeUserId, [id]),
