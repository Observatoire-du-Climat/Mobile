...
class BirdMigrationDetails extends MeasureDetails {
  final BirdMigration item;

  const BirdMigrationDetails({
    super.key,
    required this.item,
  });
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            DetailRow(label: "Espèce", value: item.specie.label),
            DetailRow(label: "Arrivée/Départ", value: item.event.label),
